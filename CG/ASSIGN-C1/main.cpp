...
void draw(float a[8][3]){
    ...
    glColor3f(0.9,0.6,0.7); //left
    glVertex3fv(a[0]);
    glVertex3fv(a[4]);
    glVertex3fv(a[7]);
    glVertex3fv(a[3]);

    glColor3f(0.2,0.8,0.6);  //right
    glVertex3fv(a[1]);
    glVertex3fv(a[2]);
    glVertex3fv(a[6]);
    glVertex3fv(a[5]);

    glColor3f(0.2,0.5,0.6); //up
    glVertex3fv(a[2]);
    glVertex3fv(a[3]);
    glVertex3fv(a[7]);
    glVertex3fv(a[6]);

    glColor3f(0.3,0.7,0.2);//back
    glVertex3fv(a[4]);
    glVertex3fv(a[5]);
    glVertex3fv(a[6]);
    glVertex3fv(a[7]);
...
void Axes(){
     glColor3f (255.0, 0.0, 255.0);               // Set the color to BLACK
     glBegin(GL_LINES);
     glVertex2s(-1000,0);
     glVertex2s(1000,0);
     glEnd();
...
void init(void){
    glClearColor(0,0,0,0); //set backgrond color to white
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("3D-cube Tranformations");
